...
{
    leaderboardData = (await getDocs(collection(Firestore, "espgenius"))).docs
    .map((item) => 
    {
        return item.data();
    });
...
app.post('/salvar', async (req, res) => {
    ...
    if (nome) {
        ...
        await addDoc(collection(Firestore, "espgenius"), { Nome: nomeArmazenado, Score: pontuacao })

        // Fim Mudanças
        res.json({ message: 'Sinal e nome recebidos com sucesso!', pontuacao: pontuacao, nome: nomeArmazenado });
    } else {
